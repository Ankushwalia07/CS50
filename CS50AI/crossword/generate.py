...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        """
        data_copy = copy.deepcopy(self.domains)

        #Iterate through each variable
        for variable in data_copy:
            #len of variable as for understanding the height
            length = variable.length
            #iterating through words in data
            for word in data_copy[variable]:
                 # if length of the word doesn't fit variable, delete it from original domain data
                if len(word) != length:
    ...
    def ac3(self, arcs=None):
        ...
        if not arcs:
            ...
            queue = []
            # Append the overlapping words into queue
           ...
           #loop through the queue to revise the arc consistency of the elements of the queue
            while len(queue) > 0:
                x, y = queue.pop(0)
                if self.revise(x, y):
    ...
    def assignment_complete(self, assignment):
        ...
        """
        # Check if all variables in the domains are assigned in the assignment;
        # return False if any variable is unassigned, otherwise, return True
    ...
    def order_domain_values(self, var, assignment):
        ...
        """
        # Make dictionary for holding varaible
        word_dict = {}

        #getting neighbours for variable
        ...
        #Sorting variables dictionary by number by elimination
